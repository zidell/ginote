...
const settings = {
  en: { language: 'Language', sidebarLabel: 'Settings', patReplacementPlaceholder: 'Enter only to replace the saved PAT', backgroundRefreshInterval: 'Check for new notes', refreshDisabled: 'Off', minutes: 'minutes', hours: 'hours', lockSessionDuration: 'Remember lock code for (cleared on refresh)', lockSessionHelp: 'How long an entered lock number stays reusable in this browser before locked notes ask for it again.', editorMaxWidth: 'Content max width' },
  ko: { language: '언어', sidebarLabel: '설정', patReplacementPlaceholder: '저장된 PAT를 변경할 때만 입력하세요', backgroundRefreshInterval: '새 노트 확인 주기', refreshDisabled: '사용 안 함', minutes: '분', hours: '시간', lockSessionDuration: '잠금번호 기억시간(새로고침시 자동 해제)', lockSessionHelp: '한 번 입력한 잠금 숫자를 이 브라우저에서 얼마나 재사용할지 정합니다. 시간이 지나면 잠금 노트가 숫자를 다시 묻습니다.', editorMaxWidth: '본문 최대 너비' },
