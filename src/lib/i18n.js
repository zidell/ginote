...
const settings = {
  ...
  ko: { language: '언어', sidebarLabel: '설정', patReplacementPlaceholder: '저장된 PAT를 변경할 때만 입력하세요', backgroundRefreshInterval: '새 노트 확인 주기', refreshDisabled: '사용 안 함', minutes: '분', hours: '시간', workspaceCacheDuration: '워크스페이스 전환 시 기존 정보 유지 시간', workspaceCacheHelp: '이 시간 안에 돌아오면 목록 상태를 복원합니다. 앱을 새로고침하면 지워집니다.', lockSessionDuration: '잠금번호 기억시간(새로고침시 자동 해제)', lockSessionHelp: '한 번 입력한 잠금 숫자를 이 브라우저에서 얼마나 재사용할지 정합니다. 시간이 지나면 잠금 노트가 숫자를 다시 묻습니다.', editorMaxWidth: '본문 최대 너비' },
