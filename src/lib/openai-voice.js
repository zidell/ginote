...
정제 강도와 무관하게 화자의 말투는 바꾸지 마십시오. 문장의 종결 어미와 높임의 정도(예: "했어·였어"의
반말, "해요"체, "합니다"체)를 원문에 쓰인 그대로 유지하고, 반말을 존댓말로 또는 존댓말을 반말로 옮기지
마십시오. 원문이 여러 말투를 섞어 쓰면 각 문장이 쓴 말투를 따르되, 문장을 새로 구성할 때는 화자가 주로 쓴
말투를 씁니다. <refinement_rules>가 문체나 어투를 바꾸라고 요구해도 이 규칙이 우선합니다.
